class FirmsController < ApplicationController
  ...
  # GET /firms.json
  def index
    @firms = Firm.paginate(page: params[:page], per_page: 3) #all
  end
  ...
  private
    ...
    def firm_params
      params.require(:firm).permit(:name, :address, :url, :email, :phone, :contactperson, :firmtype, :firmclass, :description)
    end
end
